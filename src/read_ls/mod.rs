...
pub fn get_folder_contents(current_folder: &str, folder_symbol: String, file_symbol:String) -> Result<Vec<Entry>,Error> {
    ...
    previous_folder.pop();
    entries.push(Entry::new(previous_folder, String::from(".."), Item::Folder));
